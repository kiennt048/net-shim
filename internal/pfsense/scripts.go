...
//go:embed scripts/dns_redirect.php
var PhpDNSRedirectScript string

//go:embed scripts/adguard_manage.php
var PhpAdGuardManageScript string

//go:embed scripts/doh_dot_block.php
var PhpDoHDotBlockScript string
